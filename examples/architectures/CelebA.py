...
from examples.architectures.utils import Flatten, StochasticLinear, Reshape, make_stack, make_cnn_stack, make_cnn_deconv_stack
from torch.distributions import Normal, Independent

from examples.models import ConditionalDistribution
